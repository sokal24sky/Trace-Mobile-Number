    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('ai_qr_codes.title') ?></li>
            </ol>
        </nav>
    <?php endif ?>

    <h1 class="h4 mb-4"><?= l('ai_qr_codes.title') ?></h1>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes/</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request GET \<br />
                                --url '<?= SITE_URL ?>api/ai-qr-codes/' \<br />
                        ...
                        <pre data-shiki="json">
{
    "data": [
        {
            "id": 1,
            "name": "Example name",
            "ai_qr_code": "<?= SITE_URL ?>uploads/ai_qr_codes/example.png",
            "content": "<?= SITE_URL ?>",
            "prompt": "<?= l('ai_qr_codes.prompt_placeholder') ?>"
            "embedded_data": "<?= SITE_URL ?>",
    ...
    "links": {
        "first": "<?= SITE_URL ?>api/ai-qr-codes?page=1",
        "last": "<?= SITE_URL ?>api/ai-qr-codes?page=1",
        "next": null,
        "prev": null,
        "self": "<?= SITE_URL ?>api/ai-qr-codes?page=1"
    }
}</pre>
                        </div>
                    </div>
            ...
            <div id="qr_codes_read" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes/</span><span class="text-primary">{ai_qr_code_id}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request GET \<br />
                                --url '<?= SITE_URL ?>api/ai-qr-codes/<span class="text-primary">{ai_qr_code_id}</span>' \<br />
                                --header 'Authorization: Bearer <span class="text-primary" <?= is_logged_in() ? 'data-toggle="tooltip" title="' . l('api_documentation.api_key') . '"' : null ?>><?= is_logged_in() ? $this->user->api_key : '{api_key}' ?></span>' \
                            </div>
                        </div>
                    </div>
            ...
            <div id="qr_codes_create" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                ...
                                --form 'prompt=<span class="text-primary"><?= l('ai_qr_codes.prompt_placeholder') ?></span>' \<br />
                                --form 'content=<span class="text-primary"><?= SITE_URL ?></span>' \<br />
                            </div>
                        </div>
                    </div>
            ...
            <div id="qr_codes_update" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-info mr-3">POST</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes/</span><span class="text-primary">{ai_qr_code_id}</span>
                            </div>
                        </div>
                    </div>
            ...
            <div id="qr_codes_delete" class="collapse">
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-danger mr-3">DELETE</span> <span class="text-muted"><?= SITE_URL ?>api/ai-qr-codes/</span><span class="text-primary">{ai_qr_code_id}</span>
                            </div>
                        </div>
                    </div>
