                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            ...
                            <?php if($row->country_code): ?>
                                <a href="<?= url('links-statistics?' . $data->filters->get_get() . '&type=city_name&country_code=' . $row->country_code . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $row->country_code ?>" class=""><?= get_country_from_country_code($row->country_code) ?></a>
                            <?php else: ?>
