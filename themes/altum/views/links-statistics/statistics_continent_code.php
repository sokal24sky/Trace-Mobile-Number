                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            <?php if($row->continent_code): ?>
                                <a href="<?= url('links-statistics?' . $data->filters->get_get() . '&type=country&continent_code=' . $row->continent_code . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>" title="<?= $row->continent_code ?>" class=""><?= $row->continent_code ? get_continent_from_continent_code($row->continent_code) : l('global.unknown') ?></a>
                            <?php else: ?>
