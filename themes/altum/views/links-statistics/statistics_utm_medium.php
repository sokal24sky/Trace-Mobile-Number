    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <h3 class="h5 text-truncate m-0"><?= sprintf(l('link_statistics.utm_medium'), $data->utm_source) ?></h3>
            </div>
                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            <a href="<?= url('links-statistics?' . $data->filters->get_get() . '&type=utm_campaign&utm_source=' . $data->utm_source . '&utm_medium=' . $row->utm_medium . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><?= $row->utm_medium ?></a>
                        </div>
