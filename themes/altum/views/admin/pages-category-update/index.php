...
<div class="d-flex justify-content-between mb-4">
    <h1 class="h3 mb-0 text-truncate"><i class="fas fa-fw fa-xs fa-book text-primary-900 mr-2"></i> <?= l('admin_pages_category_update.header') ?></h1>

    <?= include_view(THEME_PATH . 'views/admin/pages-categories/admin_pages_category_dropdown_button.php', ['id' => $data->pages_category->pages_category_id, 'resource_name' => $data->pages_category->title, 'url' => $data->pages_category->url, 'language' => $data->pages_category->language]) ?>
</div>
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input id="url" type="text" name="url" class="form-control <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" placeholder="<?= l('global.url_slug_placeholder') ?>" value="<?= $data->pages_category->url ?>" onchange="update_this_value(this, get_slug)" onkeyup="update_this_value(this, get_slug)" maxlength="256" required="required" />
            ...
            <div class="form-group">
                ...
                <input id="title" type="text" name="title" class="form-control <?= \Altum\Alerts::has_field_errors('title') ? 'is-invalid' : null ?>" value="<?= $data->pages_category->title ?>" maxlength="256" required="required" />
            ...
            <div class="form-group" data-type="internal">
                ...
                <input id="description" type="text" name="description" class="form-control" value="<?= $data->pages_category->description ?>" maxlength="256" />
            </div>

            <div class="form-group">
                <label for="icon"><i class="fas fa-fw fa-sm fa-icons text-muted mr-1"></i> <?= l('global.icon') ?></label>
                <input id="icon" type="text" name="icon" class="form-control" placeholder="<?= l('global.icon_placeholder') ?>" value="<?= $data->pages_category->icon ?>" maxlength="32" />
            ...
            <div class="collapse" id="advanced_container">
                <div class="form-group">
                    ...
                    <select id="language" name="language" class="custom-select">
                        <option value="" <?= !$data->pages_category->language ? 'selected="selected"' : null ?>><?= l('global.all') ?></option>
