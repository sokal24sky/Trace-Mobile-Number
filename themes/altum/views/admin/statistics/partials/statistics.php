...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="chart-container <?= $data->total['statistics'] ? null : 'd-none' ?>">
            <canvas id="statistics"></canvas>
        </div>
        <?= $data->total['statistics'] ? null : include_view(THEME_PATH . 'views/partials/no_chart_data.php', ['has_wrapper' => false]); ?>
    </div>
</div>
