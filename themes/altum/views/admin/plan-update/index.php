        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="ai_qr_codes_per_month_limit" name="ai_qr_codes_per_month_limit" min="-1" class="form-control" value="<?= $data->plan->settings->ai_qr_codes_per_month_limit ?>" <?= $data->plan_id == 'guest' ? 'disabled="disabled"' : null ?> />
