                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-end">
                                <?= include_view(THEME_PATH . 'views/admin/pages/admin_page_dropdown_button.php', ['id' => $row->page_id, 'resource_name' => $row->title, 'url' => $row->url, 'language' => $row->language, 'type' => $row->type]) ?>
                            </div>
                        </td>
                    </tr>
                <?php endforeach ?>
