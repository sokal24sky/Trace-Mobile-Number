    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                <h3 class="h5 text-truncate m-0"><?= isset($_GET['country_code']) ? sprintf(l('link_statistics.city_name_from_country'), get_country_from_country_code($data->country_code)) : l('global.cities') ?></h3>

                <div class="ml-2">
                    <span data-toggle="tooltip" title="<?= l('link_statistics.city_name_help') ?>">
