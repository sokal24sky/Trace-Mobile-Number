                ...
                <div class="mt-4">
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=utm_campaign&utm_source=' . $data->utm_source . '&utm_medium=' . $row->utm_medium . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><?= $row->utm_medium ?></a>
                        </div>
