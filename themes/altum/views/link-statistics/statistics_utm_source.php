                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <div class="text-truncate">
                            <?php if(!empty($row->utm_source)): ?>
                                <a href="<?= url('link-statistics/' . $data->link->link_id . '?type=utm_medium&utm_source=' . $row->utm_source . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><?= $row->utm_source ?></a>
                            <?php else: ?>
                                <?= l('global.none') ?>
                            <?php endif ?>
                        </div>
